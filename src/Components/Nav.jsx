    ...
    return (
      <>
        ...
        <section className="sm:hidden justify-end bg-slate-800 p-2 text-right">
          ...
          { showNav &&
          <div className="fixed z-10 top-0 left-0 right-0 w-full h-screen bg-slate-800/80" onClick={()=>setShowNav(false)}>
          <nav className=" text-primary flex flex-col text-xl text-center bg-slate-800  py-8 shadow-xl drop-shadow-lg rounded-b-lg">
            {links.map((i) => (
